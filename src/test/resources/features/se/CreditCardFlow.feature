...
#BRV == Letter parcel
  ...
  @CreditCardFlow
  Scenario: Test1 - Positive - CreditCard/Normal flow
    ...
    And I choose payment method "CREDITCARD"
  ...
  @CreditCardFlow
  Scenario: Test2 - Positive - CreditCard/Express24 flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
  ...
  @CreditCardFlow
  Scenario: Test3 - Positive - CreditCard/Home delivery flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
  ...
  @CreditCardFlow
  Scenario: Test4 - Positive - CreditCard/Letter parcel flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
