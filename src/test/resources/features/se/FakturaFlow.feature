...
#BRV == Letter parcel
  ...
  @FakturaFlow
  Scenario: Test1 - Positive - Faktura/Normal flow
    ...
    And I choose payment method "FAKTURA", with civic - "197501187541"
    And I choose delivery method "PKT"
    And I confirm orders
    Then I see that the order was created successfully

  @FakturaFlow
  Scenario: Test2 - Positive - Faktura/Express24 flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
  ...
  @FakturaFlow
  Scenario: Test3 - Positive - Faktura/Home delivery flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
  ...
  @FakturaFlow
  Scenario: Test4 - Positive - Faktura/Letter parcel flow
    Given I am at ellos_se
    And I click Login link
    And I check that I switch to Login page correctly
    And I click on "ShowLoginFormButton"
